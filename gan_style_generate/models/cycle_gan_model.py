...
class CycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        """
        # CycleGAN 训练时默认关闭 dropout，和原论文设置一致。
    ...
    def __init__(self, opt):
        ...
        # 日志里打印的 loss 名称；例如 D_A、G_A、cycle_A 就来自这里。
        ...
        # G_A 学 A->B；G_B 学 B->A。对 anime2photo 来说，G_B 就是“照片->动漫”。
        ...
        if self.isTrain:
            ...
            # ImagePool 会混入历史生成图，避免判别器只记住最新一批 fake，训练更稳。
    ...
    def set_input(self, input):
        ...
        # direction 可以交换 A/B 域；默认 AtoB 时 real_A 来自 trainA，real_B 来自 trainB。
    ...
    def forward(self):
        ...
        # 循环一致性：A->B->A 和 B->A->B，保证风格迁移后还能还原内容。
    ...
    def backward_G(self):
        ...
        # combined loss and calculate gradients
        # 生成器总 loss = 对抗 loss + 循环一致性 loss + identity loss。
    ...
    def optimize_parameters(self):
        ...
        # G_A and G_B
        # 更新生成器时冻结判别器，避免判别器参数被生成器 loss 影响。
        self.set_requires_grad([self.netD_A, self.netD_B], False)  # Ds require no gradients when optimizing Gs
        self.optimizer_G.zero_grad()  # set G_A and G_B's gradients to zero
        self.backward_G()  # calculate gradients for G_A and G_B
        self.optimizer_G.step()  # update G_A and G_B's weights
        # D_A and D_B
        # 更新判别器时重新打开梯度，分别学习区分真实图和生成图。
